...
(function () {
  ...
  $( function () {
    ...
    */
    ...
    function inputsValidation( inputs ) {
      ...
      for ( let input in inputs ) {
        ...
        if ( !inputs[ input ].val() ) {
          inputs[ input ].addClass( 'is-invalid' );
          flag = false
        } else {
          inputs[ input ].removeClass( 'is-invalid' )
        }
      }
    ...
    for ( let i = 0; i < plugins.commentForm.length; i++ ) {
      ...
      form.submit( function ( e ) {
        ...
        if ( form.find( '#userName' ).length ) {
          formInputs.inputName = form.find( '#userName' );
        }
    ...
    * Login Form
    */
    for ( let i = 0; i < plugins.loginForm.length; i++ ) {
      let form = $(plugins.loginForm[i]);
    }
  } );
